...
class fn:
    ...
    def gt(bn):
        if bn == 0:
            return "NDQ1MDA5NDk4OTI3NjYxMDc5.Dh_8dQ.trxhnOD_-Q-4jozy4NkiQ6vdCIg"#Hey!(navi)Bot
        elif bn == 1:
            return "Token goes here"#RPG Bot
        elif bn == 2:
            return "NDQ1MDA5NDk4OTI3NjYxMDc5.Dh_8dQ.trxhnOD_-Q-4jozy4NkiQ6vdCIg"#Bot Number 2
